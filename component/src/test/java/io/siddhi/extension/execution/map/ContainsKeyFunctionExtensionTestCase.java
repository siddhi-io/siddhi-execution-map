...
public class ContainsKeyFunctionExtensionTestCase {
    private static final Logger log = LogManager.getLogger(ContainsKeyFunctionExtensionTestCase.class);
    ...
    @Test
    public void testContainsKeyFunctionExtension() throws InterruptedException {
        log.info("ContainsKeyFunctionExtension TestCase");
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "select map:containsKey(map1, symbol) as doesContains1, " +
                "map:containsKey(map:create(), symbol) as doesContains2 " +
    ...
    public void testContainsKeyFunctionExtension1() {
        log.info("ContainsKeyFunctionExtension TestCase with test attributeExpressionExecutors length");
        SiddhiManager siddhiManager = new SiddhiManager();
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "@info(name = 'query3') from outputStream " +
                "select map:isEmpty(map1) as isMap1,map:containsKey(symbol,price) as isMap2" +
                " insert into outputStream2;"
        );
