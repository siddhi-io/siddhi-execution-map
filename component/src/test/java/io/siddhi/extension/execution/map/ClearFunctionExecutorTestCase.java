...
public class ClearFunctionExecutorTestCase {
    private static final Logger log = LogManager.getLogger(ClearFunctionExecutorTestCase.class);
    ...
    public void testClearFunctionExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') " +
                ...
                "@info(name = 'query3') " +
                "from outputStream " +
                "select map:clear(map1) as isMap1 " +
        ...
        siddhiAppRuntime.addCallback("outputStream2", new StreamCallback() {
            ...
            public void receive(Event[] events) {
                ...
                for (Event event : events) {
                    ...
                    AssertJUnit.assertEquals(new HashMap<>(), event.getData(0));
                    eventArrived = true;
                }
            }
        });
    ...
    public void testClearFunctionExtension1() {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "select map:isMap(map1) as isMap1,map:clear(symbol,price) as isMap2" +
                " insert into outputStream2;"
        );
    ...
    public void testClearFunctionExtension3() {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "as map1 insert into outputStream;" +
                "@info(name = 'query3') from outputStream " +
                "select map:isMap(map1) as isMap1,map:clear(symbol) as isMap2" +
                " insert into outputStream2;"
        );
