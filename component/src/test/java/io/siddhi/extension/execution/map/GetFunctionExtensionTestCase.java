...
public class GetFunctionExtensionTestCase {
    private static final Logger log = (Logger) LogManager.getLogger(GetFunctionExtensionTestCase.class);
    ...
    public void testGetFunctionExtension4() throws InterruptedException {
        ...
        AssertJUnit.assertTrue(((UnitTestAppender) logger.getAppenders().
                get("UnitTestAppender")).getMessages().contains("First attribute value must be of type java.util.Map"));
        siddhiAppRuntime.shutdown();
