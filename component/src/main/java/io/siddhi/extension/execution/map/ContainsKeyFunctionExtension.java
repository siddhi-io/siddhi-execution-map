...
@Extension(
        ...
        parameters = {
                @Parameter(name = "map",
                        description = "The map the need to be determined which contains the key or not.",
        ...
        examples = @Example(
                ...
                description = "Returns 'true' if the students contains key `1234` else it returns `false`.")
)
