...
### putAll *<a target="_blank" href="https://siddhi.io/en/v4.x/docs/query-guide/#function">(Function)</a>*

<p style="word-wrap: break-word">Returns the updated to.map after copying all of the mappings from the specified from.map. If you have duplicate keys, from.map will overwrite the values in to.map.</p>
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Map to which mappings needs to be copied in to.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">OBJECT</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Map from which mappings are copied from.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">OBJECT</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
...
```
<p style="word-wrap: break-word">Returns the updated map named to.map after adding each mapping from from.map.</p>
